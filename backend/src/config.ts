...
const defaults: IConfig = {
  'MEMPOOL': {
    ...
    'POOLS_JSON_URL': 'https://raw.githubusercontent.com/trumpowppc/mining-pools-trmp/master/pools.json',
    'POOLS_JSON_TREE_URL': 'https://api.github.com/repos/trumpowppc/mining-pools-trmp/git/trees/master',
    'AUDIT': false,
  ...
  'EXTERNAL_DATA_SERVER': {
    'MEMPOOL_API': 'https://trmpspace.trumpow.meme/api/v1',
