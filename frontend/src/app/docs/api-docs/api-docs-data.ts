...
if __name__ == "__main__":
    ws = websocket.WebSocketApp("wss://trmpspace.trumpow.meme/api/v1/ws",
                              on_open=on_open,
  ...
  },
  {
    ...
    codeExample: {
      default: {
        ...
        const response = await fetch(\`https://trmpspace.trumpow.meme/api/address/\${address}/utxo-hex\`);
...
export const faqData = [
  ...
  },
  {
    ...
    title: "How big is the mempool used by trmpspace.trumpow.meme?",
  ...
  },
  {
    ...
    title: "Can I install Trumpow Spaceusing Docker?",
  },
  {
    type: "endpoint",
    category: "self-hosting",
